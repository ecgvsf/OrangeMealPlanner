package com.example.orangemealplanner.Adapters;
...
import com.example.orangemealplanner.Models.Recipe;
...
public class RandomRecipeAdapter extends RecyclerView.Adapter<RandomRecipeViewHolder>{
    ...
    public void onBindViewHolder(@NonNull RandomRecipeViewHolder holder, int position) {
        ...
        holder.textView_type.setText(list.get(position).dishTypes.get(0).toUpperCase());
...
class RandomRecipeViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView textView_title, textView_servings, textView_like, textView_time, textView_type;
